        ...
        <?php if (is_header_show($header_class['is_shortcode'])): ?>
            <div class="mk-header-holder">
                ...
                <div class="mk-header-inner">
                    ...
                    <!-- Kasun - Header mobile call button -->
                    <?php if ( is_active_sidebar( 'header_mob_call_btn' ) ) : ?>
                        <div id="header_below_mobile" class="header_below_mobile">
                            <div class="widget-area" role="complementary">
                                <?php dynamic_sidebar( 'header_mob_call_btn' ); ?>
                            </div>
                        </div>
                    <?php endif; ?>
