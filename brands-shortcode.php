...
class AJB_All_Brands_Shortcode
{

    public static function all_series_shortcode($atts)
    {
        ...
        ?>
            <div class="pwb-brands-cols-outer">
                ...
                foreach ($outArray as $brand) {
                    ...
                    $attachment_id = get_term_meta($brand_id, 'hero_image', 1);
                    $attachment_html = $brand_name;
                    if ($attachment_id != '') {
                        $attachment_html = wp_get_attachment_image_src($attachment_id, $image_size);
                    }
                ?>
                    <div class="pwb-brands-col3 brand-<?php echo $brand_id; ?>">
                        ...
                        <div>
                            <a href="<?php echo $brand_link; ?>" title="<?php echo $brand_name; ?>" style="background-image:url('<?php echo $attachment_html[0]; ?>');" class="brand-cover">&nbsp;</a>
                        </div>
...
add_shortcode('pwb-all-series', array(
    'AJB_All_Brands_Shortcode',
    'all_series_shortcode'
));
